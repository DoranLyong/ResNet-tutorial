...
"""
(ref) https://youtu.be/DkNIBBBvcPs
(ref) https://github.com/aladdinpersson/Machine-Learning-Collection/blob/master/ML/Pytorch/CNN_architectures/pytorch_resnet.py
(ref) 포멧 따라하기; https://github.com/DoranLyong/VGG-tutorial/blob/main/VGG_pytorch/VGG_for_CIFAR10.py
...
"""
ResNet50 네트워크를 활용해 CIFAR10 분류하기 
    * ResNet50 : 학습 가능한 weight가 있는 레이어가 50개 있다는 의미 

1. Create ResNet50 model  
2. Set device 
3. Hyperparameters 
4. Load Data (CIFAR10)
