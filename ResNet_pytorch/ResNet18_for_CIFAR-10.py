...
"""
(ref) https://github.com/ndb796/Deep-Learning-Paper-Review-and-Practice/blob/master/code_practices/ResNet18_CIFAR10_Train.ipynb
...
"""
ResNet18 을 활용해 CIFAR-10 숫자 분류하기 
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        """
        self.conv1 = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)  # RGB 입력이니 => in_channel = 3
...
model = ResNet18()      
x = torch.randn(64, 3, 28, 28)    # Batch = 64, 이미지 크기= 3 x 28 x 28
...
file_name = 'resnet18_cifar10.pth.tar'
